...
The forecasts are more precise in the allocation of seats per party in each constituency, based on the quality of the data. However, results presented by the model at the level of political groups are merely indicative, considering that it is not possible to forecast statistically the decision of MEPs or parties on which political group to affiliate to. The model in this progrmam assumes an affiliation to one political group per political party in a constituency. But as we know, this does not refleft practice. 
